...
// let makeCapital = prompt("Enetr your Name"); 
...
//     alert(coverSentence);
// }else{
//     alert("tey something else")
// }

//==================================================================================

// let Symm = prompt("Enter the Symbolls * ");
// let NUM = prompt("enter The Number");
// if (Symm !== 0 ){
//     let ans = Symm.repeat(NUM);
//     alert (ans);
// }else{
//     alert ("Try somthing else");
// }

//==================================================================================

// let  myProfile= prompt("Enter your name");
// let newName =  myProfile.replace(" ",".");
// alert(newName);

//==================================================================================

// let giveInput = prompt("Enter the String");
// if (giveInput.toLowerCase().indexOf("javascript")!=-1){
//     alert ("great! you're learning Js")
// }else{
//     alert("Try somthing Else");  
// }
...
// let line = prompt("Enert the string ");
